...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      // تحويل الوسوم من الشكل { tag: Tag } إلى Tag مباشرة
            ...
            <div key={project.id} className="card hover:shadow-medium transition group">
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center gap-2">
                  ...
                  {project.archived && (
                    <span className="badge bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-300 flex items-center gap-1">
              ...
              <div className="flex justify-end gap-2 pt-4 border-t border-gray-100 dark:border-dark-100">
